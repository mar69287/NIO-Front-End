      ...
      <div className='flex gap-5 text-[#000]'>
        {
          client.account ? (
            ...
            // >
              <div className='bg-[#7B61FF] text-white py-1 px-3 rounded-[4px] text-base xl:text-lg' onClick={() => setIsOpen(true)}>
        ...
        {/* the comment below will be the actual code once we implement logged in routing */}
        {/* {
          !hasWeb3 ? (
            <Button href="https://metamask.io/" className='bg-[#7B61FF] text-white py-1 px-3 rounded-[4px] text-base xl:text-lg'>Download Metamask</Button>
            ) : (
